...
const questionsList = [
  {
    ...
    options: ['Pani Puri', 'Dahi Bhalle', 'Dal Makhani', 'Chicken Tikka Masala'],
    answer: "1"
  },
  {
...
function displayQuestion(question) {
  console.log(`Q: ${questionCount} ${question.question} \n 1. ${question.options[0]} \n 2. ${question.options[1]} \n 3. ${question.options[2]} \n 4. ${question.options[3]} \n`);
